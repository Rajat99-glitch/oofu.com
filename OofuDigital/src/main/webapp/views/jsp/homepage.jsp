...
<body>
	...
	<div class="container-xxl bg-white p-0">
		...
		<%@ include file="/views/jspf/navbar.jspf" %>
		...
		<%@ include file="/views/jspf/about.jspf" %>

		<%@ include file="/views/jspf/services.jspf" %>

		<%@ include file="/views/jspf/portfolio.jspf" %>
		
		<%@ include file="/views/jspf/testimonial.jspf" %>

		<%@ include file="/views/jspf/team.jspf" %>
